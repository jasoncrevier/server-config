# Basic server setup
Use this section to learn how to set up some basic security as well as helpful tools for running services on a new server.

## On this page
- [Create a non-root user](#create)
...
- [Use a docker-compose file to set up a basic server stack](#docker)


## Create a non-root user and disable logging in as root<a id="create"></a>
...
## Base install compose stack<a id="docker"></a>
